...
# Vercel/serverless defaults: keep persistent state under /tmp and allow an env-backed token pool.
chat2api_data_dir = os.getenv('CHAT2API_DATA_DIR', '/tmp/chat2api')
